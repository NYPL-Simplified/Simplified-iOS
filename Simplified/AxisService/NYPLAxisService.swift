...
@objc class NYPLAxisService: NSObject {
  ...
  private let metadataDownloader: NYPLAxisMetadataContentDownloading
  private let packageDownloader: NYPLAxisPackageDownloading
  ...
  init(axisItemDownloader: NYPLAxisItemDownloading,
       ...
       metadataDownloader: NYPLAxisMetadataContentDownloading,
       packageDownloader: NYPLAxisPackageDownloading) {
    ...
    self.axisItemDownloader.delegate = weakSelf
  }
...
extension NYPLAxisService {
  ...
  ///   - bookVaultId: BookVaultID for the given book
  ...
  convenience init(axisKeysProvider: NYPLAxisKeysProviding,
    ...
    let packageDownloader = NYPLAxisPackageDownloader(
      axisItemDownloader: axisItemDownloader, axisKeysProvider: axisKeysProvider,
      baseURL: baseURL, parentDirectory: dedicatedWriteURL)
