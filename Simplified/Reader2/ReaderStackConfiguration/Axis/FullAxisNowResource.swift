...
class FullAxisNowResource: TransformingResource {
  ...
  /// - Note: After decrypting the resource, we get a raw compressed data stream with no header which
