...
struct NYPLAxisProtectedAssetHandler: NYPLAxisProtectedAssetHandling {
  ...
  let decryptor: NYPLAxisContentDecrypting
  let licenseDownloader: NYPLAxisItemDownloading
  
  init(
    axisKeysProvider: NYPLAxisKeysProviding = NYPLAxisKeysProvider(),
    decryptor: NYPLAxisContentDecrypting,
    licenseDownloader: NYPLAxisItemDownloading = NYPLAxisItemDownloader(dispatchGroup: DispatchGroup())) {
