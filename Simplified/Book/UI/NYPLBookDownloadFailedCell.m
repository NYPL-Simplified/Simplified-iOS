...
- (void)setup
{
  self.backgroundColor = [NYPLConfiguration downloadBackgroundColor];
  
  self.authorsLabel = [[UILabel alloc] init];
  self.authorsLabel.font = [UIFont systemFontOfSize:12];
  self.authorsLabel.textColor = [NYPLConfiguration defaultBackgroundColor];
  ...
  self.cancelButton.backgroundColor = [NYPLConfiguration defaultBackgroundColor];
  self.cancelButton.tintColor = [NYPLConfiguration fieldTextColor];
  ...
  self.titleLabel.textColor = [NYPLConfiguration defaultBackgroundColor];
  [self.contentView addSubview:self.titleLabel];
  
  self.tryAgainButton = [[NYPLRoundedButton alloc] initWithType:NYPLRoundedButtonTypeNormal isFromDetailView:NO];
  self.tryAgainButton.backgroundColor = [NYPLConfiguration defaultBackgroundColor];
  self.tryAgainButton.tintColor = [NYPLConfiguration fieldTextColor];
