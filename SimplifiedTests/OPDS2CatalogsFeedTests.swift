...
class OPDS2CatalogsFeedTests: XCTestCase {
  ...
  func testAccountSetAuthenticationDocument() {
    do {
      ...
      XCTAssertEqual(gpl.details?.cardCreatorUrl, "https://catalog.ci.glendora.ca.us/polaris/patronaccount/selfregister.aspx?ctx=3.1033.0.0.1")
      ...
      XCTAssertEqual(gpl.details?.getLicenseURL(.eula), URL(string: "http://www.librarysimplified.org/EULA.html"))
      ...
      XCTAssertEqual(gpl.details?.supportsBarcodeScanner, true)
      XCTAssertEqual(gpl.details?.supportsBarcodeDisplay, true)
      XCTAssertEqual(gpl.details?.patronIDKeyboard, .numeric)
      XCTAssertEqual(gpl.details?.pinKeyboard, .numeric)
      ...
      XCTAssertEqual(acl.details?.cardCreatorUrl, nil)
      ...
      XCTAssertEqual(acl.details?.getLicenseURL(.eula), URL(string: "http://www.librarysimplified.org/EULA.html"))
      ...
      XCTAssertEqual(acl.details?.supportsBarcodeScanner, false)
      XCTAssertEqual(acl.details?.supportsBarcodeDisplay, false)
      XCTAssertEqual(acl.details?.patronIDKeyboard, .numeric)
      XCTAssertEqual(acl.details?.pinKeyboard, .standard)
      ...
      XCTAssertEqual(dpl.details?.cardCreatorUrl, nil)
      ...
      XCTAssertEqual(dpl.details?.supportsBarcodeScanner, false)
      XCTAssertEqual(dpl.details?.supportsBarcodeDisplay, false)
      XCTAssertEqual(dpl.details?.patronIDKeyboard, .standard)
      XCTAssertEqual(dpl.details?.pinKeyboard, .standard)
      ...
      XCTAssertEqual(nypl.details?.cardCreatorUrl, nil)
      ...
      XCTAssertEqual(nypl.details?.getLicenseURL(.eula), URL(string: "http://www.librarysimplified.org/EULA.html"))
      ...
      XCTAssertEqual(nypl.details?.supportsBarcodeScanner, true)
      XCTAssertEqual(nypl.details?.supportsBarcodeDisplay, true)
      XCTAssertEqual(nypl.details?.patronIDKeyboard, .standard)
      XCTAssertEqual(nypl.details?.pinKeyboard, .numeric)
      XCTAssertEqual(nypl.details?.authPasscodeLength, 4)
